...
--17
Select  Year(SaleDate) as SalesYear, SUM(SaleAmount) from sales
...
--25
select * from Orders
Select ProductID,year(OrderDate)years, Min(Quantity) minimum, Max(Quantity) Maximum from Orders
